...
{
	// http://www.zagstudio.com/blog/488#.VZdDDPmqqko
    public class ListBoxDragDrop : ListBox
    {
		...
		public static readonly DependencyProperty IsDragSourceProperty =
			DependencyProperty.RegisterAttached("IsDragSource", typeof(bool), typeof(ListBoxDragDrop), new UIPropertyMetadata(false, IsDragSourceChanged));

		public static readonly DependencyProperty IsDropTargetProperty =
			DependencyProperty.RegisterAttached("IsDropTarget", typeof(bool), typeof(ListBoxDragDrop), new UIPropertyMetadata(false, IsDropTargetChanged));

		public static readonly DependencyProperty DragDropTemplateProperty =
			DependencyProperty.RegisterAttached("DragDropTemplate", typeof(DataTemplate), typeof(ListBoxDragDrop), new UIPropertyMetadata(null));
		...
		{			
			this.Loaded += ListBoxDragDrop_Loaded;
		}


		// singleton
		private static ListBoxDragDrop instance;
		private static ListBoxDragDrop Instance
		{
			get
			{
		...
		// List box loaded
		public void ListBoxDragDrop_Loaded(object sender, EventArgs e)
		{
			// Set the template of the floating item when dragging - template is same as item template
			SetDragDropTemplate(this, this.ItemTemplate);
		}


		// Is Drag source changed
		...
		// Check if Drop Data Type allowed
	...
	public class DraggedAdorner : Adorner
	{
		...
		public void SetPosition(double left, double top)
		{
			...
			{
				try // TODO : error here when drag item off the left of the listbox a little bit and move around
				{ // System.InvalidOperationException - Cannot access adorners on element that has no adorners
